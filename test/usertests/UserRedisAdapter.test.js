...
describe("When using redis storage service", () => {
    ...
    it("then the json is parsed and returned", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          ...
          instance.set(
            "User_12345",
            '{"sub": "test3@localuser.com","email":"test3@localuser.com", "first_name": "Tester", "last_name" : "Testing"}',
          );
          mocks.redis = instance;
          return instance;
        };
    ...
    it("if the user does not exist false is returned", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          const instance = new Redis(args);
          instance.set(
            "User_test3@localuser.com",
            '[{"sub": "test@localuser.com"}]',
          );
          mocks.redis = instance;
          return instance;
        };
      ...
      let userStorage = require("./../../src/app/user/adapter/UserRedisAdapter");
      const actual = await userStorage.changePassword(
        "test@localuser.com",
        "my-new-password",
      );
    ...
    it("if the user exists the record is updated", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          ...
          instance.set(
            "User_test3@localuser.com",
            '{"sub": "test3@localuser.com","email":"test3@localuser.com", "first_name": "Tester", "last_name" : "Testing", "salt":"123456768"}',
          );
          mocks.redis = instance;
          return instance;
        };
  ...
  describe("then when i call create", () => {
    ...
    it("null is returned if no username and/or password is specified", async () => {
      ...
      let userStorage = require("./../../src/app/user/adapter/UserRedisAdapter");
      const actual = await userStorage.create(
        username,
        password,
        firstName,
        lastName,
    ...
    it("returns an existing user if the username already exists", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          ...
          instance.set(
            "User_12345",
            '{"sub": "12345","email":"test3@localuser.com", "first_name": "Tester", "last_name" : "Testing"}',
          );
          mocks.redis = instance;
          return instance;
        };
    ...
    it("a list of users is returned matching the ids", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          ...
          instance.set(
            "User_54321",
            '{"sub": "54321","email":"test4@localuser.com", "first_name": "Retset", "last_name" : "Gnitset"}',
          );
          mocks.redis = instance;
          return instance;
        };
    ...
    it("if the user exists the record is updated", async () => {
      ...
      jest.mock("ioredis", () => {
        ...
        return function (...args) {
          ...
          instance.set(
            "User_test3@localuser.com",
            '{"sub": "test3@localuser.com","email":"test3@localuser.com", "first_name": "Tester", "last_name" : "Testing", "salt":"123456768", "status":1}',
          );
          mocks.redis = instance;
          return instance;
        };
