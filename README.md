# DfE Sign-in Directories

**DfE Sign-in Directories** provides an API used for managing and delivering user data. This service is part of the wider **login.dfe** project.
